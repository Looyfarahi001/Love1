...
# Python bytecode 2.7
# Decompiled from: Python 2.7.17 (default, Dec  5 2021, 10:45:36) 
# [GCC 4.2.1 Compatible Android (5220042 based on r346389c) Clang 8.0.7 (https://
# Embedded file name: <Looy Farahi001>
...
\033[1;94m               (__)                  
 ...
 \033[32;1mCreator \033[37;1m: \033[33;1mLooy Farahi001
...
def subs():
    os.system('clear')
    print logo
    print 'Opens Telegram'
    time.sleep(1)
    os.system('xdg-open https://www.Telegram.com/t.me/farah_Tech/')
    masuk()
...
def masuk():
    ...
    print '\x1b[37;1m[\x1b[32;1m04\x1b[37;1m] \x1b[34;1mfollow Looy in Telegram'
...
def token():
    ...
    try:
        ...
        os.system('xdg-open https://Telegram.com/T.me/Farah_Tech')
        bot_komen()
    except KeyError:
        print 'Token Wrong'
        time.sleep(1.7)
...
def tutor():
    ...
    if cuk == '1' or cuk == '01':
        print 'Opens Telegram'
        time.sleep(1)
        os.system('xdg-open https://Telegram/T.me/Farah_Hack')
        masuk()
...
def donasi():
    ...
    print 'Opens Telegram'
    time.sleep(1)
    os.system('xdg-open https://www.Telegram.com/Farah_Hack/')
    menu()
...
def menu():
    ...
    print '\x1b[37;1m[\x1b[32;1m05\x1b[37;1m] \x1b[34;1mDonate to Mr-Farahi'
